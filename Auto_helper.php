...
namespace app\modules\sysmanage\controllers;

use Yii;
use app\modules\sysmanage\components\Helper;
use yii\caching\TagDependency;
use app\modules\sysmanage\components\RouteRule;
use app\modules\sysmanage\components\Configs;
...
use app\modules\sysmanage\controllers\RouteController;
...
class AutoController extends RouteController
{
    ...
    public function actionPermissions()
    {
        ...
        $tree = Helper::toIndexArray($items, true);
